...
const SelectSetting: React.FC<SelectSettingProps> = ({
  ...
  <div className="flex flex-col space-y-1 py-3 border-b border-gray-100 last:border-b-0">
    ...
    <select
      ...
      value={value}
      onChange={onChange}
      className="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-lg shadow-sm focus:outline-none focus:ring-[orange-600] focus:border-[orange-600] text-sm"
    >
      {options.map((opt) => (
