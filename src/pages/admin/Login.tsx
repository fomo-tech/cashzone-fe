    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-2xl border border-gray-200">
        <div className="text-center mb-6">
          <Lock className="w-10 h-10 text-[#E91E63] mx-auto mb-3" />
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-pink-500 focus:border-[#E91E63] transition"
            />
            {errors.email && (
          ...
          <button
            ...
            className={clsx(
              "w-full py-3 bg-[#E91E63] text-white font-semibold rounded-lg hover:bg-[#E91E63] transition shadow-lg flex items-center justify-center"
              // {
