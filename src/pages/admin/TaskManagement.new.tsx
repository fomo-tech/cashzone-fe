    ...
    <div className="min-h-screen p-4 sm:p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-gradient-to-r hover:from-orange-400 hover:to-orange-1000 hover:text-white text-sm"
        >
          <Plus size={18} />
          Tạo nhiệm vụ
        </button>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="p-1 text-orange-500 hover:bg-gradient-to-r hover:from-orange-50 hover:to-orange-100 rounded"
                        >
                          <Edit size={16} />
                        </button>
                        <button
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <button
                  ...
                  className="mt-2 px-4 py-2 bg-gradient-to-r from-orange-400/10 to-orange-1000/10 text-orange-500 border border-orange-500/30 rounded-lg hover:bg-gradient-to-r hover:from-orange-400 hover:to-orange-1000 hover:text-white text-sm flex items-center gap-2"
                >
                  <Plus size={16} />
                  Thêm bước hướng dẫn
                </button>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-2 bg-gradient-to-r from-orange-400 to-orange-1000 text-white rounded-lg hover:from-orange-500 hover:to-orange-600"
                >
