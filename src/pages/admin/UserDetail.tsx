      ...
      {!hasTransactions ? (
        ...
        <>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      {txn.status === "COMPLETED" ? (
                        <span className="inline-flex items-center gap-1 px-3 py-1 text-xs font-semibold rounded-full bg-gradient-to-r from-orange-400/10 to-orange-1000/10 text-orange-500 border border-orange-500/30">
          ...
          <div className="mt-6 pt-4 border-t border-gray-200 text-right">
            <button className="inline-flex items-center gap-2 text-sm font-semibold text-orange-500 hover:text-orange-500 transition-colors">
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="bg-gradient-to-br from-orange-400 to-orange-1000 p-4 rounded-xl border border-orange-500">
        ...
        <div className="bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs bg-gradient-to-r from-orange-400/10 to-orange-1000/10 text-orange-500 border border-orange-500/30 px-2 py-1 rounded-full">
      ...
      <div className="flex gap-2 pt-4 border-t border-gray-200">
        <button className="flex-1 bg-gradient-to-r from-orange-400/10 to-orange-1000/10 text-orange-500 border border-orange-500/30 hover:from-orange-400 hover:to-orange-1000 hover:text-white font-medium py-2 px-4 rounded-lg transition-all flex items-center justify-center gap-2">
      ...
      {(affiliate.directReferrals || 0) > 0 && (
        <div className="mt-4 p-3 bg-gradient-to-r from-yellow-50 to-orange-100 border border-yellow-200 rounded-lg">
          <div className="flex items-center gap-2">
...
export default function UserDetailPage() {
  ...
  if (loading["global"]) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-50 to-orange-100/30">
        <div className="flex flex-col items-center space-y-4">
          <div className="w-16 h-16 border-4 border-orange-500 border-t-orange-500 rounded-full animate-spin"></div>
      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-50 to-orange-100/30">
        <div className="text-center">
          ...
          <button
            ...
            className="mt-4 px-6 py-2 bg-gradient-to-r from-orange-400 to-orange-1000 text-white rounded-lg hover:from-orange-500 hover:to-orange-600 transition"
          >
            Quay lại danh sách
          </button>
        </div>
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-gray-50 to-orange-100/30 font-sans">
      {/* HEADER - Green theme */}
          ...
          {statCards.map((card, index) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div
                  className={`p-3 rounded-xl bg-gradient-to-br from-orange-400 to-orange-1000 ${card.color}`}
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-200">
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
                <h4 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                  <User2 className="w-5 h-5 text-orange-500" /> Thông tin Cơ bản
                </h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-base">
                ...
                <div className="flex flex-col">
                  <span className="font-semibold text-gray-600 flex items-center gap-2 mb-2">
                    <Shield className="w-4 h-4 text-orange-500" /> Vai trò
                  </span>
            ...
            {/* 2. Thông tin Ví tiền */}
            <div className="bg-gradient-to-br from-orange-400 to-orange-1000 p-6 sm:p-8 rounded-2xl shadow-lg text-white">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
              <h4 className="text-lg font-bold text-gray-900 mb-4 pb-3 border-b border-gray-200 flex items-center gap-2">
                <Settings className="w-5 h-5 text-orange-500" /> Hành động
              </h4>

              <div className="flex flex-col gap-3">
                <button
                  onClick={() => navigate(`/admin/users/edit/${user._id}`)}
                  className="flex items-center justify-center gap-2 w-full py-3 px-4 text-base font-semibold rounded-xl text-white bg-gradient-to-r from-orange-400 to-orange-1000 hover:from-orange-500 hover:to-orange-600 shadow-lg shadow-orange-500/30 transition duration-200 transform hover:scale-[1.02]"
                >
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all"
                  min="0"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all resize-none"
                  rows={3}
                />
              </div>
