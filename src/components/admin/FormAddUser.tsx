    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="mt-1 w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none"
      ...
      <div className="flex items-center justify-between">
        ...
        <label className="relative inline-flex items-center cursor-pointer">
          ...
          />
          <div
            className="w-11 h-6 bg-gray-200 rounded-full peer-checked:bg-green-500 
      ...
      <div className="pt-4">
        <button
          type="submit"
          className="cursor-pointer w-full py-2 rounded-xl bg-green-600 text-white font-medium hover:bg-green-700 transition"
        >
