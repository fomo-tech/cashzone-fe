...
const PlatformSelect: React.FC<PlatformSelectProps> = ({
  ...
  return (
    <select
      ...
      required={required}
      disabled={disabled}
      className={`w-full px-3 py-2.5 md:px-4 md:py-3 border-2 border-gray-200 rounded-xl md:rounded-2xl focus:outline-none focus:ring-2 focus:ring-[orange-600]/20 focus:border-[orange-600] transition-all bg-white text-gray-800 text-sm md:text-base ${className}`}
    >
