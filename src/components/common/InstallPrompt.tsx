...
const InstallPrompt = () => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl border border-orange-100 p-4 sm:p-5">
        <button
        ...
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-orange-400 to-orange-1000 rounded-xl flex items-center justify-center shadow-lg">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-gradient-to-r from-orange-400 to-orange-1000 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300 active:scale-95"
              >
                Cài đặt
              </button>
              <button
