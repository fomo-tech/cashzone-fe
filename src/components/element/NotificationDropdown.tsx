...
const NotificationDropdown = () => {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      <button
        onClick={() => setOpen((v) => !v)}
        className={`relative group text-white bg-gradient-to-br from-orange-400 to-orange-1000 hover:from-orange-500 hover:to-orange-600 p-2 rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-orange-300/50 transform hover:scale-110 ${
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 h-6 w-6 rounded-full ring-2 ring-white bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center text-xs font-bold text-white shadow-lg animate-pulse">
      ...
      {open && (
        <>
          ...
          >
            {/* Header với gradient */}
            <div className="relative px-4 sm:px-5 py-3 sm:py-4 border-b border-gray-100/50 bg-gradient-to-r from-orange-50/50 to-orange-100/50">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="p-2 bg-gradient-to-br from-orange-400 to-orange-1000 rounded-xl shadow-lg">
                    <Bell className="w-4 h-4 text-white" strokeWidth={2} />
                  </div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold bg-gradient-to-r from-orange-400 to-orange-1000 bg-clip-text text-transparent">
                      Thông báo
                    </h3>
                ...
                {unreadCount > 0 && (
                  <button
                    onClick={markAllRead}
                    className="group flex items-center gap-1.5 px-2 sm:px-3 py-1.5 text-xs font-semibold text-orange-500 hover:text-white hover:bg-gradient-to-r hover:from-orange-400 hover:to-orange-1000 rounded-lg transition-all duration-200 hover:shadow-lg"
                  >
                ...
                <div className="divide-y divide-gray-100/50">
                  {items.map((item, index) => (
                    <div
                      ...
                      className={`group relative px-3 sm:px-5 py-3 sm:py-4 cursor-pointer transition-all duration-200 hover:bg-gradient-to-r hover:from-orange-50/50 hover:to-orange-100/50 ${
                    ...
                    >
                      ...
                      {!item.read && (
                        <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-orange-400 to-orange-1000" />
                      )}
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0 pr-6 sm:pr-8">
                          <div className="flex items-start justify-between gap-2 mb-1">
                            ...
                            {!item.read && (
                              <span className="shrink-0 w-2 h-2 bg-gradient-to-br from-red-500 to-red-600 rounded-full shadow-sm" />
                            )}
                          </div>
            ...
            <div className="sticky bottom-0 bg-white/90 backdrop-blur-sm border-t border-gray-100/50 p-3">
              <button
                ...
                className="w-full py-2.5 px-4 text-sm font-semibold text-white bg-gradient-to-r from-orange-400 to-orange-1000 hover:from-orange-500 hover:to-orange-600 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
              >
