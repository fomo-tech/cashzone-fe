...
export const SelectTrigger: React.FC<SelectTriggerProps> = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "flex h-11 w-full items-center justify-between rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-medium transition-all duration-200 hover:border-gray-300 hover:bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-orange-500/20 shadow-sm",
